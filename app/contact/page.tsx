...
export const metadata: Metadata = {
  ...
  description:
    "Contact Winepress Solar Services for a free, no-obligation solar system quote. Fill in the form and our team will respond within 24 hours — or chat directly on WhatsApp.",
  alternates: { canonical: "https://winepresssolar.com/contact" },
  openGraph: {
    url: "https://winepresssolar.com/contact",
    title: "Contact Winepress Solar Services | Free Solar Quote",
    description:
